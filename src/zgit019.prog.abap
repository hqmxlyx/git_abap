...
IF R39 = 'X'.
  DATA:WA_REQUIREMENTS_ITEM        TYPE BAPISITEMR,
       IT_REQUIREMENTS_SCHEDULE_IN TYPE STANDARD TABLE OF BAPISSHDIN WITH HEADER LINE,
       IT_RETURN39                   TYPE STANDARD TABLE OF BAPIRETURN1 WITH HEADER LINE.

  WA_REQUIREMENTS_ITEM-MATERIAL = '000000104010000530'.
  WA_REQUIREMENTS_ITEM-MATERIAL_LONG = '000000104010000530'.
  WA_REQUIREMENTS_ITEM-PLANT = '8701'.
  WA_REQUIREMENTS_ITEM-REQU_TYPE = 'VSE'.
  WA_REQUIREMENTS_ITEM-VERSION = '00'.
  WA_REQUIREMENTS_ITEM-VERS_ACTIV = 'X'.


  IT_REQUIREMENTS_SCHEDULE_IN-DATE_TYPE = '3'."1天 2星期 3月 4记帐期间 5计划日历期间
  IT_REQUIREMENTS_SCHEDULE_IN-REQ_DATE = '20220101'.
  IT_REQUIREMENTS_SCHEDULE_IN-REQ_QTY = '12'.
  APPEND IT_REQUIREMENTS_SCHEDULE_IN.


  CALL FUNCTION 'BAPI_REQUIREMENTS_CREATE'
    EXPORTING
      REQUIREMENTS_ITEM        = WA_REQUIREMENTS_ITEM
    TABLES
      REQUIREMENTS_SCHEDULE_IN = IT_REQUIREMENTS_SCHEDULE_IN
      RETURN                   = IT_RETURN39.

  LOOP AT IT_RETURN39 ASSIGNING FIELD-SYMBOL(<WA_RETURN39>) WHERE TYPE = 'E' OR TYPE = 'A'.
